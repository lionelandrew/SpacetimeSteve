...
namespace SocialPlay.Bundles
{
    public class BundleSystem : MonoBehaviour
    {
        ...
        //static public void Get(string assetName, Action<UnityEngine.Object> callback,bool isAlwaysCallback=false) \/ Defaulted group name \/
        //{
        //    Get(assetName, callback, "Default", isAlwaysCallback);
        //}
        ...
        private static void CheckIfAssetExistsInOtherGroup(string assetName, string groupName)
        {
            ...
            {
                throw new Exception("Unable To get new asset: " + assetName + " under group name: " + groupName + " because it has already been used for group: " + AssetGroupRefences[assetName]);
            }
        }
        ...
        private static void DownloadAssetFromServerOrCache(string assetName, Action<UnityEngine.Object> callback, string groupName, bool isAlwaysCallback)
        {
            ...
            AssetBundleGetter.LoadFromCacheOrDownload(assetName, GetBundleVersion(assetName), OnRecievedAssetFromServerOrCache, isAlwaysCallback);
        }
        ...
        ///Always returns 1 for use with item system where evey asset is only versioned once
        static int GetBundleVersion(string assetName)
        {
            return 1;
        }
