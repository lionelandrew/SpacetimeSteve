          ...
          //  {
                ...
                item.AssetBundle(
                    (UnityEngine.Object bundleObj) => {
                        ...
                        dropObject.transform.position = new Vector3(dropPosition.x + UnityEngine.Random.Range(-2, 2), dropPosition.y, dropPosition.z + UnityEngine.Random.RandomRange(-2, 2));
